      ...
      <div className="container px-4 md:px-6 max-w-3xl mx-auto">
        ...
        <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="mb-8 text-center">
          ...
          <p className="text-lg text-gray-600">
            Answer honestly - there are no right or wrong answers. This helps us understand your unique personality.
          </p>
        </motion.div>
              ...
              {currentQ.type === "slider" && (
                <div className="space-y-6">
                  ...
                  <div className="text-center">
                    <span className="text-lg font-semibold text-purple-600">Current: {answers[currentQ.id] || 3}</span>
                  </div>
                </div>
              )}
            </CardContent>
        ...
        >
          <p className="text-gray-600">
            {progress < 50
              ? "You're doing great! Keep going to unlock your personality insights ✨"
              : progress < 80
                ? "Almost there! Your personalized career matches are waiting 🚀"
                : "Final stretch! Get ready to discover your perfect career path 🎯"}
          </p>
        </motion.div>
      </div>
    </div>
